 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const _=` ${l} `;class v{constructor(t,e,n,i){this.strings=t,this.values=e,this.type=n,this.processor=i}getHTML(){const t=this.strings.length-1;let e="",n=!1;for(let i=0;i<t;i++){const t=this.strings[i],s=t.lastIndexOf("\x3c!--");n=(s>-1||n)&&-1===t.indexOf("--\x3e",s+1);const r=g.exec(t);e+=null===r?t+(n?_:d):t.substr(0,r.index)+r[1]+r[2]+h+r[3]+l}return e+=this.strings[t]}getTemplateElement(){const t=document.createElement("template");return t.innerHTML=this.getHTML(),t}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const A=new class{handleAttributeExpressions(t,e,n,i){const s=e[0];if("."===s){return new C(t,e.slice(1),n).parts}return"@"===s?[new E(t,e.slice(1),i.eventContext)]:"?"===s?[new N(t,e.slice(1),n)]:new b(t,e,n).parts}handleTextExpression(t){return new P(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.1.2");const $=(t,...e)=>new v(t,e,"html",A),Y=133;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */function H(t,e){const{element:{content:n},parts:i}=t,s=document.createTreeWalker(n,Y,null,!1);let r=U(i),o=i[r],a=-1,l=0;const d=[];let c=null;for(;s.nextNode();){a++;const t=s.currentNode;for(t.previousSibling===c&&(c=null),e.has(t)&&(d.push(t),null===c&&(c=t)),null!==c&&l++;void 0!==o&&o.index===a;)o.index=null!==c?-1:o.index-l,o=i[r=U(i,r)]}d.forEach(t=>t.parentNode.removeChild(t))}const R=t=>{let e=11===t.nodeType?0:1;const n=document.createTreeWalker(t,Y,null,!1);for(;n.nextNode();)e++;return e},U=(t,e=-1)=>{for(let n=e+1;n<t.length;n++){const e=t[n];if(m(e))return n}return-1};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const ut=(t,e)=>{const n=t.startNode.parentNode,i=void 0===e?t.endNode:e.startNode,s=n.insertBefore(f(),i);n.insertBefore(f(),i);const r=new P(t.options);return r.insertAfterNode(s),r},pt=(t,e)=>(t.setValue(e),t.commit(),t),mt=(t,e,n)=>{const i=t.startNode.parentNode,s=n?n.startNode:t.endNode,r=e.endNode.nextSibling;r!==s&&((t,e,n=null,i=null)=>{for(;e!==n;){const n=e.nextSibling;t.insertBefore(e,i),e=n}})(i,e.startNode,r,s)},ft=t=>{r(t.startNode.parentNode,t.startNode,t.endNode.nextSibling)},gt=(t,e,n)=>{const i=new Map;for(let s=e;s<=n;s++)i.set(t[s],s);return i},yt=new WeakMap,_t=new WeakMap,vt=n((t,e,n)=>{let i;return void 0===n?n=e:void 0!==e&&(i=e),e=>{if(!(e instanceof P))throw new Error("repeat can only be used in text bindings");const s=yt.get(e)||[],r=_t.get(e)||[],o=[],a=[],l=[];let d,c,h=0;for(const e of t)l[h]=i?i(e,h):h,a[h]=n(e,h),h++;let u=0,p=s.length-1,m=0,f=a.length-1;for(;u<=p&&m<=f;)if(null===s[u])u++;else if(null===s[p])p--;else if(r[u]===l[m])o[m]=pt(s[u],a[m]),u++,m++;else if(r[p]===l[f])o[f]=pt(s[p],a[f]),p--,f--;else if(r[u]===l[f])o[f]=pt(s[u],a[f]),mt(e,s[u],o[f+1]),u++,f--;else if(r[p]===l[m])o[m]=pt(s[p],a[m]),mt(e,s[p],s[u]),p--,m++;else if(void 0===d&&(d=gt(l,m,f),c=gt(r,u,p)),d.has(r[u]))if(d.has(r[p])){const t=c.get(l[m]),n=void 0!==t?s[t]:null;if(null===n){const t=ut(e,s[u]);pt(t,a[m]),o[m]=t}else o[m]=pt(n,a[m]),mt(e,n,s[u]),s[t]=null;m++}else ft(s[p]),p--;else ft(s[u]),u++;for(;m<=f;){const t=ut(e,o[f+1]);pt(t,a[m]),o[m++]=t}for(;u<=p;){const t=s[u++];null!==t&&ft(t)}yt.set(e,o),_t.set(e,l)}});var wt={},St=/d{1,4}|M{1,4}|YY(?:YY)?|S{1,3}|Do|ZZ|([HhMsDm])\1?|[aA]|"[^"]*"|'[^']*'/g,bt="[^\\s]+",xt=/\[([^]*?)\]/gm,Pt=function(){};function Nt(t,e){for(var n=[],i=0,s=t.length;i<s;i++)n.push(t[i].substr(0,e));return n}function Ct(t){return function(e,n,i){var s=i[t].indexOf(n.charAt(0).toUpperCase()+n.substr(1).toLowerCase());~s&&(e.month=s)}}function kt(t,e){for(t=String(t),e=e||2;t.length<e;)t="0"+t;return t}var Mt=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],Et=["January","February","March","April","May","June","July","August","September","October","November","December"],Tt=Nt(Et,3),At=Nt(Mt,3);wt.i18n={dayNamesShort:At,dayNames:Mt,monthNamesShort:Tt,monthNames:Et,amPm:["am","pm"],DoFn:function(t){return t+["th","st","nd","rd"][t%10>3?0:(t-t%10!=10)*t%10]}};var Dt={D:function(t){return t.getDate()},DD:function(t){return kt(t.getDate())},Do:function(t,e){return e.DoFn(t.getDate())},d:function(t){return t.getDay()},dd:function(t){return kt(t.getDay())},ddd:function(t,e){return e.dayNamesShort[t.getDay()]},dddd:function(t,e){return e.dayNames[t.getDay()]},M:function(t){return t.getMonth()+1},MM:function(t){return kt(t.getMonth()+1)},MMM:function(t,e){return e.monthNamesShort[t.getMonth()]},MMMM:function(t,e){return e.monthNames[t.getMonth()]},YY:function(t){return kt(String(t.getFullYear()),4).substr(2)},YYYY:function(t){return kt(t.getFullYear(),4)},h:function(t){return t.getHours()%12||12},hh:function(t){return kt(t.getHours()%12||12)},H:function(t){return t.getHours()},HH:function(t){return kt(t.getHours())},m:function(t){return t.getMinutes()},mm:function(t){return kt(t.getMinutes())},s:function(t){return t.getSeconds()},ss:function(t){return kt(t.getSeconds())},S:function(t){return Math.round(t.getMilliseconds()/100)},SS:function(t){return kt(Math.round(t.getMilliseconds()/10),2)},SSS:function(t){return kt(t.getMilliseconds(),3)},a:function(t,e){return t.getHours()<12?e.amPm[0]:e.amPm[1]},A:function(t,e){return t.getHours()<12?e.amPm[0].toUpperCase():e.amPm[1].toUpperCase()},ZZ:function(t){var e=t.getTimezoneOffset();return(e>0?"-":"+")+kt(100*Math.floor(Math.abs(e)/60)+Math.abs(e)%60,4)}},Vt={D:["\\d\\d?",function(t,e){t.day=e}],Do:["\\d\\d?"+bt,function(t,e){t.day=parseInt(e,10)}],M:["\\d\\d?",function(t,e){t.month=e-1}],YY:["\\d\\d?",function(t,e){var n=+(""+(new Date).getFullYear()).substr(0,2);t.year=""+(e>68?n-1:n)+e}],h:["\\d\\d?",function(t,e){t.hour=e}],m:["\\d\\d?",function(t,e){t.minute=e}],s:["\\d\\d?",function(t,e){t.second=e}],YYYY:["\\d{4}",function(t,e){t.year=e}],S:["\\d",function(t,e){t.millisecond=100*e}],SS:["\\d{2}",function(t,e){t.millisecond=10*e}],SSS:["\\d{3}",function(t,e){t.millisecond=e}],d:["\\d\\d?",Pt],ddd:[bt,Pt],MMM:[bt,Ct("monthNamesShort")],MMMM:[bt,Ct("monthNames")],a:[bt,function(t,e,n){var i=e.toLowerCase();i===n.amPm[0]?t.isPm=!1:i===n.amPm[1]&&(t.isPm=!0)}],ZZ:["[^\\s]*?[\\+\\-]\\d\\d:?\\d\\d|[^\\s]*?Z",function(t,e){var n,i=(e+"").match(/([+-]|\d\d)/gi);i&&(n=60*i[1]+parseInt(i[2],10),t.timezoneOffset="+"===i[0]?n:-n)}]};Vt.dd=Vt.d,Vt.dddd=Vt.ddd,Vt.DD=Vt.D,Vt.mm=Vt.m,Vt.hh=Vt.H=Vt.HH=Vt.h,Vt.MM=Vt.M,Vt.ss=Vt.s,Vt.A=Vt.a,wt.masks={default:"ddd MMM DD YYYY HH:mm:ss",shortDate:"M/D/YY",mediumDate:"MMM D, YYYY",longDate:"MMMM D, YYYY",fullDate:"dddd, MMMM D, YYYY",shortTime:"HH:mm",mediumTime:"HH:mm:ss",longTime:"HH:mm:ss.SSS"},wt.format=function(t,e,n){var i=n||wt.i18n;if("number"==typeof t&&(t=new Date(t)),"[object Date]"!==Object.prototype.toString.call(t)||isNaN(t.getTime()))throw new Error("Invalid Date in fecha.format");e=wt.masks[e]||e||wt.masks.default;var s=[];return(e=(e=e.replace(xt,(function(t,e){return s.push(e),"@@@"}))).replace(St,(function(e){return e in Dt?Dt[e](t,i):e.slice(1,e.length-1)}))).replace(/@@@/g,(function(){return s.shift()}))},wt.parse=function(t,e,n){var i=n||wt.i18n;if("string"!=typeof e)throw new Error("Invalid format in fecha.parse");if(e=wt.masks[e]||e,t.length>1e3)return null;var s={},r=[],o=[];e=e.replace(xt,(function(t,e){return o.push(e),"@@@"}));var a,l=(a=e,a.replace(/[|\\{()[^$+*?.-]/g,"\\$&")).replace(St,(function(t){if(Vt[t]){var e=Vt[t];return r.push(e[1]),"("+e[0]+")"}return t}));l=l.replace(/@@@/g,(function(){return o.shift()}));var d=t.match(new RegExp(l,"i"));if(!d)return null;for(var c=1;c<d.length;c++)r[c-1](s,d[c],i);var h,u=new Date;return!0===s.isPm&&null!=s.hour&&12!=+s.hour?s.hour=+s.hour+12:!1===s.isPm&&12==+s.hour&&(s.hour=0),null!=s.timezoneOffset?(s.minute=+(s.minute||0)-+s.timezoneOffset,h=new Date(Date.UTC(s.year||u.getFullYear(),s.month||0,s.day||1,s.hour||0,s.minute||0,s.second||0,s.millisecond||0))):h=new Date(s.year||u.getFullYear(),s.month||0,s.day||1,s.hour||0,s.minute||0,s.second||0,s.millisecond||0),h};(function(){try{(new Date).toLocaleDateString("i")}catch(t){return"RangeError"===t.name}})(),function(){try{(new Date).toLocaleString("i")}catch(t){return"RangeError"===t.name}}(),function(){try{(new Date).toLocaleTimeString("i")}catch(t){return"RangeError"===t.name}}();var Ot=function(t,e,n,i){i=i||{},n=null==n?{}:n;var s=new Event(e,{bubbles:void 0===i.bubbles||i.bubbles,cancelable:Boolean(i.cancelable),composed:void 0===i.composed||i.composed});return s.detail=n,t.dispatchEvent(s),s},$t=function(t){Ot(window,"haptic",t)};const Yt="ontouchstart"in window||navigator.maxTouchPoints>0||navigator.msMaxTouchPoints>0;class Ht extends HTMLElement{constructor(){super(),this.holdTime=500,this.ripple=document.createElement("mwc-ripple"),this.timer=void 0,this.held=!1,this.cooldownStart=!1,this.cooldownEnd=!1}connectedCallback(){Object.assign(this.style,{position:"absolute",width:Yt?"100px":"50px",height:Yt?"100px":"50px",transform:"translate(-50%, -50%)",pointerEvents:"none"}),this.appendChild(this.ripple),this.ripple.primary=!0,["touchcancel","mouseout","mouseup","touchmove","mousewheel","wheel","scroll"].forEach(t=>{document.addEventListener(t,()=>{clearTimeout(this.timer),this.stopAnimation(),this.timer=void 0},{passive:!0})})}bind(t,e){if(t.actionHandler)return;t.actionHandler=!0,t.addEventListener("contextmenu",t=>{const e=t||window.event;e.preventDefault&&e.preventDefault(),e.stopPropagation&&e.stopPropagation(),e.cancelBubble=!0,e.returnValue=!1});const n=t=>{if(this.cooldownStart)return;let e,n;this.held=!1,t.touches?(e=t.touches[0].pageX,n=t.touches[0].pageY):(e=t.pageX,n=t.pageY),this.timer=window.setTimeout(()=>{this.startAnimation(e,n),this.held=!0},this.holdTime),this.cooldownStart=!0,window.setTimeout(()=>this.cooldownStart=!1,100)},i=n=>{this.cooldownEnd||["touchend","touchcancel"].includes(n.type)&&void 0===this.timer||(clearTimeout(this.timer),this.stopAnimation(),this.timer=void 0,this.held?Ot(t,"action",{action:"hold"}):e.hasDoubleTap?1===n.detail||"keyup"===n.type?this.dblClickTimeout=window.setTimeout(()=>{Ot(t,"action",{action:"tap"})},250):(clearTimeout(this.dblClickTimeout),Ot(t,"action",{action:"double_tap"})):Ot(t,"action",{action:"tap"}),this.cooldownEnd=!0,window.setTimeout(()=>this.cooldownEnd=!1,100))};t.addEventListener("touchstart",n,{passive:!0}),t.addEventListener("touchend",i),t.addEventListener("touchcancel",i),t.addEventListener("keyup",t=>{if(13===t.keyCode)return i(t)}),/iPhone OS 13_/.test(window.navigator.userAgent)||(t.addEventListener("mousedown",n,{passive:!0}),t.addEventListener("click",i))}startAnimation(t,e){Object.assign(this.style,{left:`${t}px`,top:`${e}px`,display:null}),this.ripple.disabled=!1,this.ripple.active=!0,this.ripple.unbounded=!0}stopAnimation(){this.ripple.active=!1,this.ripple.disabled=!0,this.style.display="none"}}customElements.define("action-handler-aftership",Ht);const Rt=(t,e)=>{const n=(()=>{const t=document.body;if(t.querySelector("action-handler-aftership"))return t.querySelector("action-handler-aftership");const e=document.createElement("action-handler-aftership");return t.appendChild(e),e})();n&&n.bind(t,e)},Ut=n((t={})=>e=>{Rt(e.committer.element,t)});console.info("%c  AFTERSHIP-CARD  \n%c  Version 1.1.9   ","color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray");let Lt=class extends ht{setConfig(t){if(!t||!t.entity)throw new Error("Invalid configuration");this._config=Object.assign({title:"Aftership"},t)}getCardSize(){return 6}shouldUpdate(t){if(t.has("_config"))return!0;if(this.hass&&this._config){const e=t.get("hass");if(e)return e.states[this._config.entity]!==this.hass.states[this._config.entity]}return!0}render(){if(!this._config||!this.hass)return $``;const t=this.hass.states[this._config.entity];if(!t)return $`
        <ha-card>
          <div class="warning">
            Entity not available: ${this._config.entity}
          </div>
        </ha-card>
      `;const e=t.attributes.trackings.filter((function(t){return"delivered"===t.status.toLowerCase()})),n=t.attributes.trackings.filter((function(t){return"delivered"!==t.status.toLowerCase()}));return $`
      <ha-card>
        <div class="header" @click=${this._moreInfo}>
          ${this._config.title}
        </div>
        ${vt(n,t=>t.tracking_number,(t,e)=>$`
              <paper-item>
                <paper-item-body>
                  <ha-icon
